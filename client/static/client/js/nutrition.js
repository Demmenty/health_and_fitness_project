...
/**
 * Update the day nutrition table with the given food data.
 *
 * @param {Object} meal - The dictionary of food items grouped by meal categories.
 * @param {Object} totalNutrition - The object containing the total nutrition data for the day.
 * @param {number} totalAmount - The total amount of food consumed for the day.
 */
function updateDayNutritionTable(meal, totalNutrition, totalAmount) {
    ...
    function updateFooter(totalNutrition, totalAmount) {
        ...
        dayTotalAmount.text(`${totalAmount}`);
