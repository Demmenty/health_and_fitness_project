...
@register.inclusion_tag("measurements/measurements_content.html", takes_context=True)
def draw_measurements_content(context, client: User, for_expert: bool = False) -> dict:
    ...
    if period_measures:
        ...
        period_as_string = (
            f"{period_chosen} {get_noun_ending(period_chosen, 'день', 'дня', 'дней')}"
        )
