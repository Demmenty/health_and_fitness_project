...
@register.inclusion_tag("measurements/anthropometry_content.html", takes_context=True)
def draw_anthropometry_content(context, client: User, for_expert: bool = False) -> dict:
