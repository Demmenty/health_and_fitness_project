...
urlpatterns = [
    ...
    path('meet_questionary/', views.client_meet_questionary, name='client_meet_questionary'),
    path('health_questionary/', views.client_health_questionary, name='client_health_questionary'),
